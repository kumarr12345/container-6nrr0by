...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6nrr0by.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6nrr0by.containers.anotherwebservice.com/
...
```
git clone git@github.com:kumarr12345/container-6nrr0by.git
cd container-6nrr0by
```
...
```
docker attach container-6nrr0by
```
